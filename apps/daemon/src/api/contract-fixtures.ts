...
const ghRoutes = {
  ...
  api: {
    ...
    // Single-issue REST fetches for issue-backed CLI spawns (issue #378:
    // the handler builds the #266 issue-context prompt when no --prompt is
    // given; these fixture routes serve those fetches).
    "/repos/sp/rp/issues/5": {
      number: 5,
      title: "Fix the flaky test",
      state: "open",
      user: { login: "someone" },
      assignee: null,
      assignees: [],
      html_url: "https://github.com/sp/rp/issues/5",
      updated_at: UPDATED_AT,
    },
    "/repos/sp/rp/issues/8": {
      number: 8,
    ...
    "/repos/sp/gate/issues/1": {
      ...
      assignee: null,
      assignees: [],
      html_url: "https://github.com/sp/gate/issues/1",
      updated_at: UPDATED_AT,
    },
    "/repos/ak/wrk1/issues/7": {
      number: 7,
      title: "Plain worker item",
      state: "open",
      user: { login: "someone" },
      assignee: null,
      assignees: [],
      html_url: "https://github.com/ak/wrk1/issues/7",
      updated_at: UPDATED_AT,
    },
    "/repos/o/pidecktest": {
