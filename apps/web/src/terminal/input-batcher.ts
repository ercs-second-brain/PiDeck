/**
 * Input coalescing for the web terminal: batches the rapid `onData` bursts
 * xterm.js produces while a key is held down (or a burst of keys is typed)
 * into fewer, larger WebSocket frames.
 *
