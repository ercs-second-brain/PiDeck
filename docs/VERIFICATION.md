...
| Running check runs (`conclusion: ""`) reported CI as failed | [#600](https://github.com/ercs-second-brain/PiDeck/pull/600) | `client.test.ts` over a real `gh pr list --json statusCheckRollup` fixture (`src/github/fixtures/`) |
