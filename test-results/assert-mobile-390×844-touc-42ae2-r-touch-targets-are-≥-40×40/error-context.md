...
- Name: assert.spec.mjs >> mobile 390×844 (touch) >> "session (live worker)" touch targets are ≥ 40×40
- Location: tools/ui-gallery/assert.spec.mjs:90:5

# Error details

```
Error: touch targets below 40px on /sessions/w-working
...
- generic [ref=e3]:
  - banner [ref=e4]:
    - generic:
      ...
      - generic: "my-api › #47 Add rate limiting to the ingest API"
    - generic [ref=e6]:
      - generic [ref=e7]:
