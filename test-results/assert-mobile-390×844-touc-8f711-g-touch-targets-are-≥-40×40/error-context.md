...
- Name: assert.spec.mjs >> mobile 390×844 (touch) >> "onboarding" touch targets are ≥ 40×40
- Location: tools/ui-gallery/assert.spec.mjs:90:5

# Error details

```
Error: touch targets below 40px on /onboarding
...
- generic [ref=e3]:
  ...
  - main [ref=e13]:
    - generic [ref=e14]:
      - heading "Set up PiDeck" [level=1] [ref=e15]
      - generic [ref=e16]:
        - generic [ref=e17]:
          - generic [ref=e18]: ✓ pi
          - generic [ref=e19]: ✓ GitHub
          - generic [ref=e20]: ✓ Review account
          - generic [ref=e21]: Repo
        - generic [ref=e22]:
          - heading "Project repository" [level=2] [ref=e23]
          - paragraph [ref=e24]: "Connect the repository this PiDeck orchestrates: clone an existing one, or create a new one on GitHub."
          - generic [ref=e25]:
            - generic [ref=e26]:
              - button "Clone existing" [ref=e27] [cursor=pointer]
              - button "Create new" [ref=e28] [cursor=pointer]
            - textbox "Repository URL" [ref=e30]:
              - /placeholder: https://github.com/owner/repo
            - button "Add project" [ref=e32] [cursor=pointer]
```
