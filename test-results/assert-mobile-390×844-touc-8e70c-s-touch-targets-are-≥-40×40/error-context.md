...
- Name: assert.spec.mjs >> mobile 390×844 (touch) >> "settings" touch targets are ≥ 40×40
- Location: tools/ui-gallery/assert.spec.mjs:90:5

# Error details

```
Error: touch targets below 40px on /settings
...
+ Array [
+   "button \"Update\" 62×26",
+   "button \"General\" 55×20",
+   "button \"Review account\" 110×20",
+   "button \"Models\" 49×20",
+   "button \"Prompts\" 58×20",
+ ]
```
...
- generic [ref=e3]:
  ...
  - main [ref=e13]:
    - generic [ref=e14]:
      ...
      - navigation [ref=e16]:
        - navigation "Settings sections" [ref=e17]:
          - button "General" [ref=e18] [cursor=pointer]
          - button "Review account" [ref=e19] [cursor=pointer]
          - button "Models" [ref=e20] [cursor=pointer]
          - button "Prompts" [ref=e21] [cursor=pointer]
      - generic [ref=e23]:
        - heading "General" [level=2] [ref=e24]
        - paragraph [ref=e25]: Read-only daemon facts; the update check compares against the running version.
        - generic [ref=e26]:
          - generic [ref=e27]:
            - generic [ref=e28]:
              - generic [ref=e29]: Poll interval
              - generic [ref=e30]: How often the daemon reconciles with GitHub.
            - generic [ref=e31]: 3600s
          - generic [ref=e32]:
            - generic [ref=e33]:
              - generic [ref=e34]: State directory
              - generic [ref=e35]: Where PiDeck keeps its state.
            - generic [ref=e36]: /tmp/pideck-gallery-TR7tCw/state
          - generic [ref=e37]:
            - generic [ref=e38]: Version
            - generic [ref=e40]: 0.1.0
        - button "Check for updates" [ref=e42] [cursor=pointer]
```
