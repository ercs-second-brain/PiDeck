...
- Name: assert.spec.mjs >> mobile 390×844 (touch) >> "session (archived log)" touch targets are ≥ 40×40
- Location: tools/ui-gallery/assert.spec.mjs:90:5

# Error details

```
Error: touch targets below 40px on /sessions/w-archived
...
- generic [ref=e3]:
  - banner [ref=e4]:
    - generic:
      ...
      - generic: "my-api › #31 archived 2026-09-11T02:11:34.806Z"
    - generic [ref=e6]:
      - generic [ref=e7]:
  ...
  - main [ref=e13]:
    - generic [ref=e14]:
      - generic [ref=e15]:
        - generic [ref=e16]:
          - generic [ref=e17]: Worker
          - 'link "issue #31" [ref=e18] [cursor=pointer]':
            - /url: https://github.com/acme/my-api/issues/31
          - 'link "PR #15" [ref=e19] [cursor=pointer]':
            - /url: https://github.com/acme/my-api/pull/15
          - generic "2026-09-11T02:11:34.806Z" [ref=e20]: spawned 3d · archived 1d
          - generic [ref=e21]: done
        - textbox "Terminal input" [ref=e27]
      - button "▸ Trace (6)" [ref=e32] [cursor=pointer]:
        - generic [ref=e33]: ▸
        - text: Trace (6)
```
