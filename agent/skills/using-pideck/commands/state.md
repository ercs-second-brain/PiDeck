...
List a project's PRs with `ciStatus` (`pending | running | success | failure | unknown`) and `reviewState` (`none | pending | approved | changes_requested`) — the CI/review triage input for CI-fix and review-addressing routing.
